...
// HTTP behaviour is covered in citybikes_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "citybikes://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("citybikes", "about")
	if err != nil || got.String() != "citybikes://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want citybikes://page/about", got.String(), err)
	}
}
