...
Most of these come down to network reality or how citybikes serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

citybikes rate-limits like any public site. citybikes already paces
...
Where a surface is gated, citybikes reads a cookie or token you supply
...
`citybikes`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what citybikes actually did
