...
```
citybikes <command> [arguments] [flags]
```

Run `citybikes <command> --help` for the full flag list on any command. This
...
per operation you declare in `citybikes/domain.go`.
